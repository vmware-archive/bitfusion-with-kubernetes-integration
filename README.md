...
The terms of the Apache License, version 2.0 Section 3 “Grant of Patent License” do not apply to the binaries in the Bitfusion Client container which are not licensed under the Apache License, version 2.0.”
